...
Open the portfolio directory in VS Code.
Click Go Live in the bottom right corner (requires the Live Server extension).
...
1. Netlify (Drag & Drop)
Visit Netlify Drop.
Drag the entire portfolio folder and drop it into the upload box.
Your site will instantly go live with a custom shareable link!
2. GitHub Pages
Push this folder to a new repository on your GitHub account (e.g., named portfolio).
Go to Settings > Pages inside the repository.
Under Build and deployment, set the source branch to main (or master) and folder to / (root).
Save, and within a minute your site will be live at https://<username>.github.io/portfolio/.
